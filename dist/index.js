...
import { getPermission, dangerousCombinations, riskWeights } from './permissions.js';
/**
 ...
 */
export function analyzePermissions(permissions, optionalPermissions = [], hostPermissions = []) {
 ...
 */
function findDangerousCombinations(permissions) {
    const found = [];
 ...
 */
function calculateRiskScore(permissions, optionalPermissions, combinations) {
    let score = 0;
 ...
 */
export async function analyze(manifestPath, options = {}) {
    ...
    // Analyze permissions
    const analysis = analyzePermissions(permissions, optionalPermissions, hostPermissions);
 ...
 */
export function formatHuman(analysis) {
    const lines = [];
