...
export type PermissionCategory = 'host' | 'api' | 'clipboard' | 'storage' | 'network' | 'tab' | 'bookmark' | 'download' | 'geolocation' | 'notification' | 'privacy' | 'debugging' | 'management' | 'experimental';
